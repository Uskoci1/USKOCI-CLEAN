...
if mode=='source':
 ...
 for item in config['proofs']:
  name=item['script'];assert re.fullmatch('[a-z_]+_proof[.]mjs',name) or name in ('v5_review_acceptance_proof.mjs','v5_ai_test_budget_proof.mjs','v5_worker_profile_proof.mjs','v5_owner_safety_legal_proof.mjs','v5_owned_media_proof.mjs','v5_account_closure_execution_proof.mjs','v5_ai_turn_recovery_proof.mjs','v5_owned_qa_recovery_proof.mjs','v5_qa_limits_proof.mjs','v5_qa_classifier_proof.mjs','v5_owned_export_proof.mjs','v5_group_conversation_proof.mjs','v5_agreement_location_proof.mjs','v5_media_evidence_proof.mjs','v5_retention_compatibility_proof.mjs','v5_worker_turn_recovery_proof.mjs','v5_unknown_ai_turn_exit_proof.mjs','v5_support_case_proof.mjs','v5_agreement_photos_proof.mjs','v5_self_reported_identity_proof.mjs')
