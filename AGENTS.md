...
See [integration, failure evidence and validation](docs/implementation/AI_MOBILE_FINAL_INTEGRATION_20260907.md). Root review and final-head CI/native acceptance are pending. Older checkpoints below retain their historical source/proof boundaries.
