...
4. `docs/authority/sources/spoj-v2/prototype/USKOCI_SPOJ_V2.html`, its original assets/motion/contracts and the current native visual layer. SPOJ V2 owns appearance/motion; Entry/Auth require signature fidelity. Use true RN/SVG, no WebView/raster HTML. Older visual donors and synthesis proposals cannot override it.
