...
| Full Home aggregate integration | Attention implemented/proven/DEV applied and client built; bounded previews remain | PKG-042 wires validated account-owned attention and fixes cancelled-Agreement reader disagreement (7.49). Activities/upcoming previews still read full lists. No pagination or fetch-reduction claim; device verification pending. |
