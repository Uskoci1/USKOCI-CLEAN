...
- Current status: IN_PROGRESS (slices 1–2 candidates; parity suites, neighbours and tsc green locally; full Jest recorded per slice; PRE-P4 green on `866f05d`). Next: Moje prijave, public Task detail, application composer. Live binding of manual entry, photo cancellation, Q&A activation and closure execution still waits for PKG-014.
