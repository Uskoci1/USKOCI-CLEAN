...
it('prepares the original intro under the held cover instead of waiting for hide to start it', async () => {
  ...
  expect(snapshot().phase).toBe('intro'); expect(mockWrite).not.toHaveBeenCalled();
