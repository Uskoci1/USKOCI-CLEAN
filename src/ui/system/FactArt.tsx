...
function drawing(kind: FactArtKind, c: Tone, muted: boolean): ReactNode {
  ...
  switch (kind) {
    ...
    case 'document': return <>{shadow}<Rect x={7.4} y={4.3} width={19.6} height={25.2} rx={4.2} fill="#C5CDC7"/><Path d="M9.8 2.6h9.4l6.4 6.4v15.9a4 4 0 0 1-4 4H9.8a4 4 0 0 1-4-4V6.6a4 4 0 0 1 4-4Z" fill="#FFFFFF" stroke="#CCD4CE" strokeWidth={1.1}/><Path d="M19.2 2.6v4.4a2 2 0 0 0 2 2h4.4Z" fill={c.front}/>{line('M10.2 13.8h10.8', c.front, 2.2)}{line('M10.2 18.3h10.8M10.2 22.8h6.6', '#7B887E', 1.7)}</>;
