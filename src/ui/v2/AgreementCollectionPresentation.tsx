...
const s = StyleSheet.create({
  ...
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 8 }, dot: { width: 6, height: 6, borderRadius: 3 }, status: { flexShrink: 1, letterSpacing: 0.3 },
  ...
  avatar: { width: 32, height: 32, borderRadius: 11, backgroundColor: sys.color.greenSoft, alignItems: 'center', justifyContent: 'center' },
