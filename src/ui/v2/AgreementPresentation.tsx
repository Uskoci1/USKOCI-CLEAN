  ...
  return <View style={[card, s.people]}>
    {agreement.ucesnici.map((person, index) => <View key={person.id} style={[s.person, index ? s.personDivider : null]}>
      ...
      <View style={s.grow}>
        ...
        <T variant="note" tone="muted">{person.viSte ? 'Vi · ' : ''}{person.uloga === 'narucilac' ? 'Naručilac' : 'Uskočer'}
...
const s = StyleSheet.create({
  ...
  avatar: { width: 40, height: 40, borderRadius: 13, backgroundColor: sys.color.greenSoft, alignItems: 'center', justifyContent: 'center' },
