...
const s = StyleSheet.create({
  ...
  inputLocked: { backgroundColor: sys.color.ground, color: sys.color.muted },
  ...
  stateChip: { backgroundColor: sys.color.ground, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 5, maxWidth: '45%' },
