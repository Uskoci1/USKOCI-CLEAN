...
const s = StyleSheet.create({
  ...
  emptyArt: { width: 84, height: 84, borderRadius: 28, backgroundColor: sys.color.greenSoft, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  card: { gap: 8, marginBottom: 12 },
  attentionCard: { borderColor: sys.color.orange }, selectedCard: { borderColor: sys.color.green },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 7 }, dot: { width: 6, height: 6, borderRadius: 3 }, status: { flexShrink: 1, letterSpacing: 0.3 },
