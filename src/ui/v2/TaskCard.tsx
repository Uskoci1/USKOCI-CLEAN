...
const s = StyleSheet.create({
  ...
  condition: { flexDirection: 'row', alignItems: 'center', gap: 5, minHeight: 26, maxWidth: 220, borderRadius: 9, paddingHorizontal: 9, paddingVertical: 4, backgroundColor: '#F4F7F5' },
  ...
  waiting: { minHeight: 26, borderRadius: 9, paddingHorizontal: 9, paddingVertical: 4, backgroundColor: sys.color.orangeSoft, justifyContent: 'center' },
