-- 04 — Dogovor
--
-- OVDE SU DVE NAMERNE RAZLIKE U ODNOSU NA DONOR:
--
-- 1) status NEMA 'AWAITING_CONFIRMATIONS'.
--    M02: izbor nepromenjene tačne Prijave ODMAH aktivira Dogovor.
--    M10: nijedna nova legacy potvrda formiranja ne sme da preživi.
--
-- 2) Tabela agreement_confirmations se NE kreira.
--    Postojala je isključivo za tu treću potvrdu.
--    U donoru se ne briše — ovde se prosto ne prenosi.
...
-- Prihvaćena verzija je autoritativna; stara ostaje nepromenljiva.
...
-- Jedna nit po Dogovoru. M03: Pregled | Poruke, bez trećeg taba.
...
-- M07: bez merdevina Krenuo/Stigao. Prozor drži server, ne telefon.
create table if not exists public.agreement_execution (
  ...
  -- Serverski rok. Klijent ga prikazuje, nikad ne računa.
