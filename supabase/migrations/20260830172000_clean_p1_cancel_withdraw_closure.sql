...
-- REPAIR rpc_ai_publish_need to use the new PUBLISH lifecycle token
create or replace function public.rpc_ai_publish_need(p_conversation_id uuid, p_profile_id uuid)
  ...
  begin
    ...
    select uid, p_profile_id, 'PUBLISHED',
      ...
      'STATIONARY', 1, statement_timestamp()
      from public.ai_structured_facts f
     where f.conversation_id = p_conversation_id limit 1
    returning id into v_need_id;
  
    update public.ai_conversations set bound_need_id = v_need_id, status = 'PUBLISHED'
