...
export function readP1LegalPredecessorPlan(root = process.cwd()) {
  return readPendingSourcePlan({ root, domain: 'P1',
    unitManifest: 'supabase/proofs/legal/p1_legal_consent_files.json',
    predecessorManifest: 'supabase/proofs/legal/p1_legal_consent_predecessor_files.json' });
}
