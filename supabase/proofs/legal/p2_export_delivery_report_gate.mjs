...
assert.deepEqual(prior.deferred_authority_successors.map(x => x.file), ['20260910162955_clean_p3_retention_execution_authority.sql','20260910172132_clean_w03_owned_ai_intake_authority.sql','20260910193029_clean_n09_expo_push_transport.sql']);
