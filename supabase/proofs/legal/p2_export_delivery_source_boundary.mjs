...
export function deliveryBoundary(currentPlan) {
  ...
  return { next, fullPlan:intake.fullPlan, historicalPlan:intake.historicalPlan, currentSourceAdmission:intake.currentSourceAdmission, deferredSuccessors: [deferred,intake.next,...intake.deferredSuccessors], predecessorPlan: { ...fullPlan,
