...
assert.equal(prior.full_source_plan.source_inventory.length,106);
assert.equal(prior.predecessor_plan.source_migration_count,104);
  assert.deepEqual(prior.deferred_authority_successors.map(x=>x.file),['20260910172132_clean_w03_owned_ai_intake_authority.sql']);
