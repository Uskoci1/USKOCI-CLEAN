...
assert.equal(prior.full_source_plan.source_migration_count,109);
assert.equal(prior.full_source_plan.source_inventory.length,109);
assert.equal(prior.predecessor_plan.source_migration_count,104);
assert.deepEqual(prior.deferred_authority_successors.map(x=>x.file),['20260910172132_clean_w03_owned_ai_intake_authority.sql','20260910193029_clean_n09_expo_push_transport.sql','20260910214845_clean_dispatch_need_lock_order.sql','20260911035330_clean_m05_agreement_change_authority.sql']);
