...
export function retentionExecutionBoundary(currentPlan) {
  ...
  return { next, fullPlan:intake.fullPlan, historicalPlan:intake.historicalPlan, currentSourceAdmission:intake.currentSourceAdmission, executionPlan:fullPlan, deferredSuccessors:[intake.next,...intake.deferredSuccessors], predecessorPlan: { ...fullPlan,
