...
import { readPendingSourcePlan } from '../legal/pending_source_plan.mjs';
...
export function readD0140aPredecessorPlan(root = process.cwd()) {
  return readPendingSourcePlan({ root, domain: 'D0140A',
    unitManifest: 'supabase/proofs/policy/d0140a_bundle_registration_files.json',
    predecessorManifest: 'supabase/proofs/policy/d0140a_bundle_registration_predecessor_files.json' });
}
