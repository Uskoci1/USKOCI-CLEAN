...
export function publicationBoundary(currentPlan) {
  ...
  return { next, fullPlan:intake.fullPlan, historicalPlan:intake.historicalPlan, currentSourceAdmission:intake.currentSourceAdmission, deferredSuccessors:[...deferredSuccessors,intake.next,...intake.deferredSuccessors], predecessorPlan: { ...fullPlan,
