...
test('every explicitly admitted V5 migration still requires manifest, provenance and future chronology',()=>{
 ...
 '20260913065130_clean_v5_agreement_private_photos.sql','20260913080237_clean_v5_self_reported_identity_requirement.sql','20260913081147_clean_v5_event_bound_account_erasure.sql','20260913081242_clean_v5_qa_owner_product_activation.sql'];
 const result=partitionHygieneInventory(fixture([applied,...names]));assert.equal(result.future.length,22);assert.equal(result.applied.length,1);
});
