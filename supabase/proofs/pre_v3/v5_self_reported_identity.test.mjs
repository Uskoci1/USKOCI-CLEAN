...
test('actual proof covers predecessor true, canonical false publication/application/selection and source drift without provider',()=>{
 ...
 assert.ok(!proof.includes('fetch('));assert.ok(!proof.includes('signInWithOAuth'));
});
