...
test "$(psql "$DB_URL" -Atc "select count(*) from public.preselection_questions;")" = "0"
test "$(psql "$DB_URL" -Atc "select count(*) from private.preselection_policy_decisions;")" = "0"
test "$(psql "$DB_URL" -Atc "select count(*) from private.preselection_commands;")" = "0"
